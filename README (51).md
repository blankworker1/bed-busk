...
| [`CITY_HANDBOOK.md`](./CITY_HANDBOOK.md) | Repeatable playbook for onboarding a new city — the barter-room partnership model, how to find and pitch a local cultural/tourism partner, and how city-by-city funding works |
| [`pitch/bosa-2027-pitch.html`](./pitch/bosa-2027-pitch.html) | One-page pitch for Fondazione Bosa — "Bosa 2027: City of Busking & Street Arts" — the first real-world instance of the City Handbook's template |
